...
var ConfirmComponent = (function () {
    ...
    ConfirmComponent.prototype.clickPlaceBet = function () {
        ...
        var confirmedBet = new __WEBPACK_IMPORTED_MODULE_5__classes_bet__["a" /* Bet */](profile, this.bet, this.bet.source, this.odds, this.betAmount, winAmount, this.betType);
...
module.exports = "<div class=\"container pt-5 pr-0 pl-0\">\n  <div class=\"row\" align=\"center\" *ngIf=\"sport==0 || sport==3 || sport==4\">\n    <div *ngFor=\"let action of actions\" class=\"card col-sm-4 mt-3 pl-0 pr-0\">\n\n      <div class=\"row pl-0 pr-0 ml-0 mr-0\">\n        <div class=\"col w-50\" align=\"left\">\n          <p class=\"m-0 pl-3\">{{action.matchDate | slice:0:6}}</p>\n        </div>\n        <div class=\"col w-50\" align=\"right\">\n          <p class=\"m-0 pr-3\">{{action.matchTime}}</p>\n        </div>\n      </div>\n\n      <div class =\"row ml-0 mr-0 w-100\" style=\"height:100px\" *ngIf=\"action.sport==0 || action.sport==4 || action.sport==3\">\n        <div class =\"col p-0 float-left\">\n          <img class=\"w-75 h-100\" src=\"{{action.awayImagePath}}\" alt=\"Card image cap\">\n        </div>\n        <h2 class=\"mt-4\">@</h2>\n        <div class =\"col p-0 float-right\">\n          <img class=\"w-75 h-100\" src=\"{{action.homeImagePath}}\" alt=\"Card image cap\">\n        </div>\n      </div>\n\n      <div class=\"card-header border-top pl-3 pr-3\">\n\n        <div align=\"left\">\n          <div class=\"row pl-3\">{{action.awayTeam}}</div>\n          <div class=\"row border-bottom pb-1 pt-1\">\n            <div class=\"col\">\n              <a class=\"btn btn-primary btn-sm text-light float-left\"(click)=\"placeBet(action,'awayTeamML')\">{{addPlus(action.awayTeamML)}}{{action.awayTeamML}}</a>\n            </div>\n            <div class=\"col\" align=\"center\">\n              <a class=\"btn btn-primary btn-sm text-light\"(click)=\"placeBet(action,'awayTeamRL')\">{{action.awayTeamRL}} {{addPlus(awayTeamRLOdds)}}{{action.awayTeamRLOdds}}</a>\n            </div>\n            <div class=\"col\">\n              <a class=\"btn btn-primary btn-sm text-light float-right\"(click)=\"placeBet(action,'under')\">u{{action.totalNumber}}  {{addPlus(action.underLine)}}{{action.underLine}}</a>\n            </div>\n          </div>\n        </div>\n\n        <div align=\"left\">\n          <div class=\"row pl-3\">{{action.homeTeam}}</div>\n          <div class=\"row pb-1 pt-1\">\n            <div class=\"col\">\n              <a class=\"btn btn-primary btn-sm text-light float-left\"(click)=\"placeBet(action,'homeTeamML')\">{{addPlus(action.homeTeamML)}}{{action.homeTeamML}}</a>\n            </div>\n            <div class=\"col\" align=\"center\">\n              <a class=\"btn btn-primary btn-sm text-light\"(click)=\"placeBet(action,'homeTeamRL')\">{{action.homeTeamRL}} {{addPlus(action.homeTeamRL)}}{{action.homeTeamRLOdds}}</a>\n            </div>\n            <div class=\"col\">\n              <a class=\"btn btn-primary btn-sm text-light float-right\" (click)=\"placeBet(action,'over')\">o{{action.totalNumber}}  {{addPlus(action.overLine)}}{{action.overLine}}</a>\n            </div>\n          </div>\n        </div>\n\n      </div>\n    </div>\n  </div>\n\n  <div class=\"row\" align=\"center\" *ngIf=\"sport==21\">\n    <div class=\"row\" *ngFor=\"let action of actions\">\n      <h1>{{action.eventName}}</h1>\n      <ul class=\"list-group w-100\">\n        <li class=\"list-group-item d-flex justify-content-between align-items-center\" *ngFor=\"let participant of action.participant\">\n          {{participant.name}}  {{addPlus(participant.odds)}}{{participant.odds}}\n        </li>\n      </ul>\n    </div>\n  </div>\n\n</div>\n"
